  ...
  return (
    <div style={{ textAlign: 'center' }}>
      ...
      <div className={cn('email-confirm-form', 'mb-1')}>
        ...
        <button className="btn-green" style={{ float: 'right' }}>ログイン後支払いへ</button>
      </div>
      <div className="mb-2">
        <a>パスワードを忘れだ場合<span className="fs-15">⇨</span></a>
      </div>
      <button className={cn('btn-green', 'mt-2')}>未登録の場合</button>
    </div>
  )
}