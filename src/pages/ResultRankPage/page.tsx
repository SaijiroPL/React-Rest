...
export default function() {
  ...
  const data = [
    { date: '2020/02/29 12:31', category: '和食', name: 'テスティング食堂名', totalScore: 85, rank: 52, allRank: 6000, qStar: 2, pscStar: 3, confirmed: false, M: 80, Q: 90, MQ: 75, P: 80, S: 80, C: 95, PSC: 85 },
    { date: '2020/02/25 11:45', category: '洋食', name: 'テスティング食堂名', totalScore: 85, rank: 52, allRank: 6000, qStar: 2, pscStar: 3, confirmed: false, M: 80, Q: 90, MQ: 75, P: 80, S: 80, C: 95, PSC: 85 },
    { date: '2020/02/20 16:11', category: '中華', name: 'テスティング食堂名', totalScore: 85, rank: 52, allRank: 6000, qStar: 2, pscStar: 3, confirmed: false, M: 80, Q: 90, MQ: 75, P: 80, S: 80, C: 95, PSC: 85 },
    { date: '2020/01/31 18:05', category: '和食', name: 'テスティング食堂名', totalScore: 85, rank: 52, allRank: 6000, qStar: 2, pscStar: 3, confirmed: true, M: 80, Q: 90, MQ: 75, P: 80, S: 80, C: 95, PSC: 85 },
    { date: '2020/01/14 11:01', category: '洋食', name: 'テスティング食堂名', totalScore: 85, rank: 52, allRank: 6000, qStar: 2, pscStar: 3, confirmed: true, M: 80, Q: 90, MQ: 75, P: 80, S: 80, C: 95, PSC: 85 },
  ]
  return (
